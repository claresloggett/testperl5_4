...
#        does not exist at the specified path, or testperl5_4 does not have permission
#        to read from the file.
# 2: A command line error occurred. This can happen if the user specifies
#        an incorrect command line argument. In this circumstance testperl5_4 will
