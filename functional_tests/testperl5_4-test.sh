...
this_program_name="testperl5_4-test.sh"
...
${this_program_name}: run integration/regression tests for testperl5_4 

Usage:
    ${this_program_name} [-h] [-v] -p program -d test_data_dir 

Example:
    ${this_program_name} -p bin/testperl5_4 -d data/tests
